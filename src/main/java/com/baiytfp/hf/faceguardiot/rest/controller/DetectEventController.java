 ...
 */
public class DetectEventController extends RestController {
    ...
    protected Object post(Request request, Response response) throws Exception {
        ...
        //具体上报的数据
        Map data = XlinkIotUtil.getInstance().getDetectEventMap(paramsMap);

        JSONObject jsonObject = XlinkIotUtil.getInstance().getXlinkIotPublish(data, XlinkIotUtil.detectEven, XlinkIotPublishOperation.Insert);
        return jsonObject;
    }
