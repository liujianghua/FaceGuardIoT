...
import com.baiytfp.hf.faceguardiot.rest.exception.Rest400StatusException;
import com.baiytfp.hf.faceguardiot.rest.exception.Rest403StatusException;
import com.baiytfp.hf.faceguardiot.rest.exception.Rest503StatusException;
import com.baiytfp.hf.faceguardiot.rest.exception.RestStatusException;
...
import com.baiytfp.hf.faceguardiot.rest.exception.Rest404StatusException;
...
public abstract class RestController {
	...
	protected final Map<String, String> getBodyMap(Request request) throws Exception{
		Map<String, String> paramsMap = new HashMap<String, String>();

		JSONObject jsonBody = getBodyJson(request);
		Iterator iterator = jsonBody.keySet().iterator();
