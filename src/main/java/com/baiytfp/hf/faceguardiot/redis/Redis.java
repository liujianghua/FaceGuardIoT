package com.baiytfp.hf.faceguardiot.redis;
...
import com.baiytfp.hf.faceguardiot.config.RedisConfig;
...
public class Redis {
	...
	private void initialPool() {
		...
		jedisPool = new JedisPool(config, RedisConfig.ip, RedisConfig.port, RedisConfig.maxWaitMillis, RedisConfig.pass);
	}
	...
	private void initialSentinelPool() {
		...
		config.setTestOnReturn(RedisConfig.testOnReturn);
		config.setTestWhileIdle(RedisConfig.testWhileIdle);
		sentinelPool = new JedisSentinelPool(RedisConfig.sentinelMasterName, RedisConfig.sentinels, config, RedisConfig.maxWaitMillis,
				RedisConfig.pass);
	}
	...
	public class Hash {
		 ...
		 * @return 存储对应的值
		 */
		public String hget(String key, String fieid, int dbIndex) {
			// ShardedJedis sjedis = shardedJedisPool.getResource();
